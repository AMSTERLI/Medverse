...
class ConvBlock_context_t2c(DefaultUnetStageBlock):
    ...
    def __post_init__(self):
        ...
        self.final_conv = Vmap(conv_fn(in_channels=self.channels,
                                        out_channels=self.channels,
                                        kernel_size=1,
                                        padding='same'))
    ...
    def forward(self,
        ...
        context_update = self.final_conv(attn_output) # B, L, C, ...
...
class PairwiseConvAvgModelBlock_c2t(DefaultUnetStageBlock):
    ...
    def __post_init__(self):
        ...
        self.final_conv = conv_fn(in_channels=self.channels,
                                   out_channels=self.channels,
                                   kernel_size=1,
                                   padding='same')
    ...
    def forward(self,
        ...
        # Apply final 1x1 convolution to the attention output
        target_update = self.final_conv(attn_output) # B, C, ...
